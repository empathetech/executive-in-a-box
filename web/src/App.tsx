...
export interface ChatMessage {
  ...
  modification?: string
  isModifiedResponse?: boolean  // true when generated by a Modify re-run (no further Modify allowed)
}
...
export default function App() {
  ...
  // Incremented on every decision so CeoHeroPanel re-fetches stats automatically.
